...
export declare function handleRetry(retryAttempts?: number, retryDelay?: number, connectionName?: string, verboseRetryLog?: boolean): <T>(source: Observable<T>) => Observable<T>;
