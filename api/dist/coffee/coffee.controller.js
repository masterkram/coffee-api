...
let CoffeeController = class CoffeeController {
    ...
    findUserCoffees(id) {
        return this.service.findUserCoffees(id);
    }
    create(data) {
...
__decorate([
    ...
    __metadata("design:paramtypes", [Number]),
    __metadata("design:returntype", void 0)
], CoffeeController.prototype, "findUserCoffees", null);
__decorate([
    common_1.Post(),
    __param(0, common_1.Body()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [coffee_dto_1.CoffeeDTO]),
    __metadata("design:returntype", void 0)
